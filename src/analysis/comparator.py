...
class PerformanceComparator:
    ...
    def compare_results(self, sqlserver_results: List[Dict[str, Any]], 
                       snowflake_results: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        ...
        # Calculate averages
        sqlserver_times = [r["execution_time_ms"] for r in sqlserver_results 
                          if r.get("status") == "success" and r.get("execution_time_ms")]
        snowflake_times = [r["execution_time_ms"] for r in snowflake_results 
                          if r.get("status") == "success" and r.get("execution_time_ms")]
        ...
        return {
            ...
            "time_difference_percent": round(time_difference_percent, 2) if time_difference_percent else None,
