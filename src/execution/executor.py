...
from ..database.connections import SQLServerConnection, SnowflakeConnection
...
class QueryExecutor:
    ...
    def __init__(self, sql_server_conn: SQLServerConnection, 
                 snowflake_conn: SnowflakeConnection,
                 parallel_workers: int = 10, timeout: int = 300):
        """
