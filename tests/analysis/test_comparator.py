...
class TestPerformanceComparator:
    ...
    def test_compare_results_basic(self, comparator, sample_sqlserver_results, sample_snowflake_results):
    ...
    def test_compare_results_calculates_averages(self, comparator, sample_sqlserver_results, sample_snowflake_results):
    ...
    def test_compare_results_determines_winner(self, comparator, sample_sqlserver_results, sample_snowflake_results):
    ...
    def test_compare_results_row_count_match(self, comparator, sample_sqlserver_results, sample_snowflake_results):
