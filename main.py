...
from src.ui.main import MainApplication  # noqa: E402
from src.utils.config_loader import ConfigLoader  # noqa: E402
from src.utils.logger import setup_logger_from_config  # noqa: E402
...
Examples:
  ...
  %(prog)s --version           # Show version information
    ...
    parser.add_argument(
        "--no-gui", action="store_true", help="Run in CLI mode (GUI not implemented yet)"
    )
...
def initialize_application(config_path=None, log_level=None):
    ...
    logger.info("=" * 60)
    logger.info("SQL Server to Snowflake Query Performance Comparison Tool")
...
def main():
    ...
    try:
        ...
        config = initialize_application(config_path=args.config, log_level=args.log_level)
